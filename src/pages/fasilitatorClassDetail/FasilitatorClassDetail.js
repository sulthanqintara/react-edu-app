                ...
                <section className="column-middle col-10 col-sm-10 col-md-4 col-lg-4 col-xl-4">
                    <div className="icon-back col-8 mb-3 mt-4">
                        <Link to="/fasilitator/class">
                            <h1><i className="fas fa-chevron-left pe-3 user-select-auto"></i>Front-end Fundamentals</h1>
                        </Link>
                    </div>
                        ...
                        <div className="container-body">
                            ...
                            <form>
                                ...
                                <div className="text-center">
                                    <Link to="/">
                                        <Button className="text-right" variant="success">Save</Button>
                                    </Link>
                                </div>
                            </form>
                        </div>
